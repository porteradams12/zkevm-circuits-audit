    ...
    [(); <TimestampedStorageLogRecord<F> as CSAllocatableExt<F>>::INTERNAL_STRUCT_LEN]:,
{
    ...
    let (
        ...
        structured_input.hidden_fsm_input.previous_tx_number,
    ...
    structured_input.hidden_fsm_output.previous_tx_number = previous_tx_number;
...
>(
    ...
    mut previous_tx_number: UInt32<F>,
    ...
    [(); <TimestampedStorageLogRecord<F> as CSAllocatableExt<F>>::INTERNAL_STRUCT_LEN]:,
{
    ...
    for _cycle in 0..limit {
        ...
        let packed_key = concatenate_key(cs, record.tx_number_in_block, record.address, record.key);
        ...
        previous_tx_number = record.tx_number_in_block;
