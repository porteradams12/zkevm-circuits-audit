...
pub const TRANSIENT_STORAGE_VALIDITY_CHECK_PACKED_KEY_LENGTH: usize = 1 + 5 + 8;
...
pub struct TransientStorageDeduplicatorFSMInputOutput<F: SmallField> {
    ...
    pub previous_packed_key: [UInt32<F>; TRANSIENT_STORAGE_VALIDITY_CHECK_PACKED_KEY_LENGTH],
    pub previous_key: UInt256<F>,
    pub previous_address: UInt160<F>,
    pub previous_timestamp: UInt32<F>,
    pub previous_tx_number: UInt32<F>,
